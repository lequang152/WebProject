...
import productionmove.btl.repository.IProductAgencyRepository;
import productionmove.btl.service.IProductAgencyService;
...
@Service
public class ProductAgencyService implements IProductAgencyService {
    @Autowired
    private IProductAgencyRepository iProductAgencyRepository;

    @Override
    public List<ProductAgency> findAll() {
        return iProductAgencyRepository.findAll();
    }

    @Override
    public List<ProductAgency> findAllByAgency(String code) {
        List<ProductAgency> list = iProductAgencyRepository.findAll();
        for(ProductAgency p: list){
            if(!p.getCodeagency().equals(code)){
                list.remove(p);
            }
        }
        return list;
    ...
    public List<ProductAgency> findAllByCategoryAndAgency(String category, String code) {
        return iProductAgencyRepository.findAllByCategoryproductAndCodeagency(category, code);
    }

    @Override
    public List<ProductAgency> findAllByCategoryAndAgencyAndCodecustomer(String category, String code, String codeCustomer) {
        return iProductAgencyRepository.findAllByCategoryproductAndCodeagencyAndCodecustomer(category, code, codeCustomer);
    }

    @Override
    public ProductAgency findById(Long id) {
        return iProductAgencyRepository.findById(id).get();
    }
    ...
    public List<ProductAgency> thongkenhapvaotheoquy(String code, String cate, int quy) throws ParseException {
        ...
        if(quy == 1){
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start1, end1, String.valueOf(a.getNgaynhap()));
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start2, end2, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start3, end3, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start4, end4, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
    ...
    public List<ProductAgency> thongkenhapvaotheothang(String code, String cate, int thang) throws ParseException {
        ...
        if(thang == 1){
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start2, finalEnd, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start5, end5, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start2, end6, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start7, end7, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start8, end8, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start9, end9, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start10, end10, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start11, end11, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start12, end12, String.valueOf(a.getNgaynhap()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
    ...
    public List<ProductAgency> thongkebantheoquy(String code, String cate, int quy) throws ParseException {
        ...
        list.removeIf(a -> !a.getCodeagency().equals(code));
        list.removeIf(a -> !a.getCategoryproduct().equals(cate));
        list.removeIf(a -> a.getNgayban() == null);
        if(quy == 1){
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start1, end1, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start2, end2, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start3, end3, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start4, end4, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
    ...
    public List<ProductAgency> thongkebantheothang(String code, String cate, int thang) throws ParseException {
        ...
        if(thang == 1){
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start2, finalEnd, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start5, end5, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start2, end6, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start7, end7, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start8, end8, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start9, end9, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start10, end10, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start11, end11, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
            ...
            list.removeIf(a -> {
                try {
                    return !Utils.checkDate(start12, end12, String.valueOf(a.getNgayban()));
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                return false;
    ...
    public ProductAgency save(ProductAgency agency) {
        return iProductAgencyRepository.save(agency);
    }
}
